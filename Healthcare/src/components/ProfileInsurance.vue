...
<div>
    <div class="navbar">
     ...
     <router-link to="/Home" >Home</router-link>
        ...
        <router-link to="/ProfileInsurance" class="active">Profile</router-link>
   ...
   <!-- </p>
   <p>Registration Number:{{ a.id}}
   <input type=text v-model="id" placeholder="Edit Registartion Number" />
   </p>
   <p>Password:{{ password }}
   <input type=text v-model="password" placeholder="Set your password" />
   </p>
   <p>Location:{{ loc }}
   <input type=text v-model="loc" placeholder="Enter your location" />
   </p>
...
methods: {
    saveProfile: async function () {
      var stakeHolder = "insurance"; // Hardcoding for now, otherwise it must be taken from current login state (Vuex store)
